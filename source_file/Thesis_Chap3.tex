...
In this chapter, we described a deep differential encoder which showcased higher estimation accuracy than a comparable RNN network while achieving lower computational complexity. In the sequel, we will augment this differential encoding network with a deep compressive sensing network. Additionally, we will draw an explicit connection between the frequency domain pilots as defined in 3GPP protocols and the delay domain CSI which many deep learning-based CSI estimation works adopt.	